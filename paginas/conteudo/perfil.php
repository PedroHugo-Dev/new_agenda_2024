            ...
            <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="senha" id="telefone" value=""
                    placeholder="**************************">
                </div>
                <div class="form-group">
          ...
          <div class="card">
            ...
            <div class="card-body p-0" style="text-align: center; margin-bottom: 98px">
              ...
              if ($foto_user == 'avatar-padrao.png') {
                ...
                echo '<img src="../img/user/' . $foto_user . '" alt="' . $foto_user . '" title="' . $foto_user . '" style="width: 200px; border-radius: 100%; margin-top: 30px">';
              }
              ?>
